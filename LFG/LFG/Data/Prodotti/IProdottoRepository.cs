...
{
    Task DeleteAllAsync(string? filterText = null, string? nome = null, string? descrizione = null, string? prezzo = null, string? codiceSku = null, string? sezione = null, Guid? categoriaId = null, Guid? collezionesId = null, CancellationToken cancellationToken = default);
    ...
    Task<long> GetCountAsync(string? filterText = null, string? nome = null, string? descrizione = null, string? prezzo = null, string? codiceSku = null, string? sezione = null, Guid? categoriaId = null, Guid? collezionesId = null, CancellationToken cancellationToken = default);
}