...
public abstract class EfCoreOrdineRepositoryBase : EfCoreRepository<LFGDbContext, Ordine, Guid>
{
    ...
    public virtual async Task DeleteAllAsync(string? filterText = null, DateTime? dataOrdineMin = null, DateTime? dataOrdineMax = null, string? stato = null, decimal? importoTotaleMin = null, decimal? importoTotaleMax = null, string? indSpedizione = null, string? metodoPagamento = null, Guid? clienteId = null, Guid? scontoId = null, CancellationToken cancellationToken = default)
    {
    ...
    public virtual async Task<OrdineWithNavigationProperties> GetWithNavigationPropertiesAsync(Guid id, CancellationToken cancellationToken = default)
    {
        ...
        return (await GetDbSetAsync()).Where(b => b.Id == id).Select(ordine => new OrdineWithNavigationProperties { Ordine = ordine, Cliente = dbContext.Set<Cliente>().FirstOrDefault(c => c.Id == ordine.ClienteId), Sconto = dbContext.Set<Sconto>().FirstOrDefault(c => c.Id == ordine.ScontoId) }).FirstOrDefault();
    }

    public virtual async Task<List<OrdineWithNavigationProperties>> GetListWithNavigationPropertiesAsync(string? filterText = null, DateTime? dataOrdineMin = null, DateTime? dataOrdineMax = null, string? stato = null, decimal? importoTotaleMin = null, decimal? importoTotaleMax = null, string? indSpedizione = null, string? metodoPagamento = null, Guid? clienteId = null, Guid? scontoId = null, string? sorting = null, int maxResultCount = int.MaxValue, int skipCount = 0, CancellationToken cancellationToken = default)
    {
        var query = await GetQueryForNavigationPropertiesAsync();
        query = ApplyFilter(query, filterText, dataOrdineMin, dataOrdineMax, stato, importoTotaleMin, importoTotaleMax, indSpedizione, metodoPagamento, clienteId, scontoId);
    ...
    public virtual async Task<long> GetCountAsync(string? filterText = null, DateTime? dataOrdineMin = null, DateTime? dataOrdineMax = null, string? stato = null, decimal? importoTotaleMin = null, decimal? importoTotaleMax = null, string? indSpedizione = null, string? metodoPagamento = null, Guid? clienteId = null, Guid? scontoId = null, CancellationToken cancellationToken = default)
    {
        var query = await GetQueryForNavigationPropertiesAsync();
        query = ApplyFilter(query, filterText, dataOrdineMin, dataOrdineMax, stato, importoTotaleMin, importoTotaleMax, indSpedizione, metodoPagamento, clienteId, scontoId);
