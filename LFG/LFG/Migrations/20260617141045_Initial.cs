        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportedEmbedderProviders = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SupportedVectorStoreProviders = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmbedderProvider = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmbedderModelName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmbedderApiKey = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EmbedderApiBaseUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VectorStoreProvider = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    VectorStoreSettings = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
