...
{
    /// <inheritdoc />
    public partial class Added_Pagamento : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdTransazione = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    OrdineId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPagamenti", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppPagamenti_AppOrdini_OrdineId",
                        column: x => x.OrdineId,
